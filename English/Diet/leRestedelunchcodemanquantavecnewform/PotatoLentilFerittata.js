...
class PotatoLentilFerittata extends Component{
...
/>
          ...
          7- tbsps of curcumin, pinch of sea salt and pepper.{"\n"}
              ...
              <Text style={this.props.DietPortrait.text}>
             1- Boil in water the lentil and the potato until be tender.{"\n"}
...
<Text style={this.props.DietLandscape.text}>
    ...
    10- Let it cook  until it is golden on both sides then remove from the heat and serve.{"\n"} 
       ...
       export default connect(mapStateToProps) (PotatoLentilFerittata);
