...
class ChickpeasGreenBeansMix extends Component{
...
/>
          ...
          6- pinch of salt , some olives.{"\n"}
              ...
              <Text style={this.props.DietPortrait.text}>
             1- Boil in water the  green beans until be tender (10 min).{"\n"}
             ...
             5- Season with olive oil, salt and sesame and decorate with same olive then serve.{"\n"}
...
<Text style={this.props.DietLandscape.text}>
     ...
     5- Season with olive oil, salt and sesame and decorate with same olive then serve.{"\n"}
       ...
       export default connect(mapStateToProps) (ChickpeasGreenBeansMix);
