...
class CucumberAppleTomatoSaladWithSesame extends Component{
...
<Image
         ...
         Cucumber Apple Tomato Salad With Sesame{"\n"}
...
<Text style={this.props.DietLandscape.text}>
     ...
     4- Mix all ingredients together and enjoy it.{"\n"}
       ...
       export default connect(mapStateToProps) (CucumberAppleTomatoSaladWithSesame);
